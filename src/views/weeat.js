            ...
            <div>
                ...
                <div>
                    ...
                    <div className='spacing container'>
                        ...
                        <p>With a diversifying population in the Greater Seattle area, there is a growing need to introduce more culturally immersive dining opportunities similar to cities such as San Francisco or New York. From the collective understanding of our team members, we have come to realize that most ethnic restaurants in the city did not offer a complete authentic experience. Instead of relying on commercial restaurants, we sought to utilize the skills and expertise of passionate home chefs to provide these experiences.</p>
                    ...
                    <div className='spacing container'>
                        ...
                        <p className='pt-2'>During our interviews we discovered there are definitely users willing to pay for dining experiences connecting them to authentic cuisines. One user mentioned they would be interested in an application that could provide “more authentic foods than restaurants and cheaper prices”, which is what our service aimed to accomplish. However, there were some users worried about the quality of food that the local chefs would be able to provide.</p>
                        <p>In terms of chefs, there were initial concerns regarding the safety and willingness to invite others into their homes to dine. While our team recognized the legitimacy of these concerns, we felt that our preliminary research was sufficient to demonstrate a demand for such a service exists. Our service would draw parallels to other on-demand companies like Airbnb and Uber that leverage the share economy.</p>
                    </div>
                    <div className='spacing container'>
                    ...
                    <div className='spacing container'>
                        ...
                        <div className='row pb-4'>
                            <div className='col-md-8'>
                                <h5>Food Lover</h5>
                                <p>We were able to identify a handful of issues regarding the app’s details and flow. Aside from functional errors with the prototype, the general consensus was that the app currently felt too similar to other restaurant finding apps already on the market. Users expected many of the same functionality that other well known apps such as Yelp provided. While the uniqueness of our application stemmed from each item in the search result being chef created events and not commercial restaurants, our users were not able to pick up on that fact from our prototypes.</p>
                            </div>
                            <div className='col-md-4'>
                        ...
                        <div className='row'>
                            <div className='col-md-8'>
                                <h5>Home Chef</h5>
                                <p>Many users had difficulty understanding the navigation, and were unsure of where to go to complete certain tasks. Many had their own difficulties understanding certain components, and were overwhelmed by the amount of information presented. Our taxonomy was unclear and participants had a hard time distinguishing an “event” from a “place”. We were able to find other small things that were unclear to the users, such as extra features that they found unnecessary in the application (namely sponsors and advertisements for restaurants and chefs).</p>
                            </div>
                            <div className='col-md-4'>
                    ...
                    <div className='spacing container'>
                        ...
                        <p>Multiple iterations of usability testing reinforced the importance of validating the need for a product with potential users. It was extremely helpful to work closely with users each sprint and adjust designs based off the feedback we received. Our team also learned the values of working in a large group setting and respecting each other’s differences of opinion in design. By achieving a balance between incorporating good ideas while tactfully declining those that didn’t quite work out, we were able to create a final product that felt consistent and complete.</p>
